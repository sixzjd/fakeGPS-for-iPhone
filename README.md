# FakeGPS v6.2.2 - iPhone 虚拟定位工具 | iOS GPS 模拟器
...
# FakeGPS v6.2.2 - iPhone Virtual Location Tool
...
- Use the GUI or the command-line interface

### Download

Get the latest release from [GitHub Releases](https://github.com/sixzjd/fakeGPS-for-iPhone/releases/latest) or [www.sixzjd.sbs](https://www.sixzjd.sbs).
